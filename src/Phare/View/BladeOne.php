...
class BladeOne
{
    ...
    /** @var string Current user. Example: john */
    public $currentUser;

    /** @var string Current role. Example: admin */
    public $currentRole;

    /** @var string[] Current permission. Example ['edit','add'] */
    ...
    /** @var string The main url of the system. Don't use raw values unless the value is sanitized */
    protected $baseUrl = '.';
    ...
    public function getCompiledFile($templateName = ''): string
    {
        ...
        $hash = $style === 'md5' ? \md5_file($fullPath) : \sha1_file($fullPath);
