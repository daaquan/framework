...
trait BladeOneHtml
{
    ...
    public function BladeOneHtml(): void
    {
        ...
        if (class_exists(MessageContainer::class)) {
...
<div class="form-check">
    ...
    public function useTabler($useCDN = false): void
    {
        $this->style = 'tabler';
        $bs4 = [
            'button' => 'btn',
...
<div class="form-check">
        ...
        if ($useCDN) {
            $this->addCss('<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@tabler/core@1.0.0-beta17/dist/css/tabler.min.css">', 'tabler');
            $this->addJs('<script src="https://cdn.jsdelivr.net/npm/@tabler/core@1.0.0-beta17/dist/js/tabler.min.js"></script>', 'tabler');
        }
    }
