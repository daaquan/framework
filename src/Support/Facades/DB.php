 ...
 * @method static \Phare\Database\Query\Builder table(string $table, string $as = null)
 * @method static \Phare\Database\Query\Expression raw($value)
 ...
 * @method static \Phare\Database\Connection beforeExecuting(\Closure $callback)
