    ...
    */
    ...
    'connections' => [
        ...
        'db' => [
            ...
            'sticky' => true, // Reuse the same connection within a request to avoid replication delay
            'strict' => false, // Error on INSERT/UPDATE with invalid or missing values
        ...
        */
        ...
        'session' => [
            ...
            'options' => [
                'persistent' => env('REDIS_PERSISTENT_CONNECTION', 0),
                'timeout' => env('REDIS_TIMEOUT', 0),
                'readTimeout' => env('REDIS_READ_TIMEOUT', 0),
            ],
        ],
